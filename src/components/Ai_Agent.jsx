  ...
  return (
    ...
    <Row>
          <Card style={{height:"auto",width:"auto",justifyContent:"space-between"}} className='mt-5 ai-card'>
                ...
                <Image fluid src='/Agent/section-left.png' className='d-none d-md-block' style={{width:"13rem", height:"18rem"}}></Image>
                ...
                <Image fluid src='Agent/section-right.png' className='d-none d-md-block'  style={{width:"13rem", height:"18rem",}}></Image>
                </Stack>
          </Card>
